...
const AppointmentPopUp = ({
  ...
  useEffect(() => {
    if (loading)
      fetchsuccess(`${SERVER}/appointment/post`, {
  ...
  useEffect(() => {
    if (successResponse != null &&
      successResponse.appointmentId != null) {
      setLoading(false);
      setSuccesful(true);
    }
  }, [successResponse]);
    ...
    <>
      ...
      >
        ...
        <ModalContent my="auto" p="2rem" borderRadius="11px">
          ...
          <ModalHeader fontSize="1.4rem" mt='0.3rem' color="gray.400" textAlign='center'>
            {`On ${selectedDate.toLocaleDateString("en-US", DATE_FOTMAT)} at ${time} ${period} with ${selectedPerson.doctorName}`}
          </ModalHeader>
          {localStorage.getItem("patientToken") != null ?
            ...
            <Text fontSize="1.4rem" mt='1rem' color="blue.400" p='1rem' textAlign='center'>
              Please log in as patient to request for appointment</Text>
          }
