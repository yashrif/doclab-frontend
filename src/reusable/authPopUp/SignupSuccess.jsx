...
const signUpSuccess = ({setCurrWindow,onModalClose})=>{
  return (
    ...
    <ModalHeader textAlign='center' fontSize='2.4rem ' color='blue.700'>Sign Up Succesful!</ModalHeader>
    <ModalHeader textAlign='center' fontSize='1.4rem' color='gray.400'>Go to Login page to Login</ModalHeader>
